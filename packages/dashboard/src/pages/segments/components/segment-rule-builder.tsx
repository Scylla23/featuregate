...
export function SegmentRuleBuilder({ rules, dispatch }: SegmentRuleBuilderProps) {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Rules use OR logic — a context matches the segment if ANY rule matches. Within each rule,
        ...
        {rules.length === 0 ? (
          <div className="rounded-lg border border-dashed py-8 text-center">
            <p className="text-sm text-muted-foreground">
              No targeting rules yet. Contexts matching any rule will be included in this segment.
            </p>
          </div>
        ) : (
          <DndContext
